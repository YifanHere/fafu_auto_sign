...
from fafu_auto_sign.crypto import generate_auth_header, generate_headers, SECRET_KEY
...
class TestGenerateHeaders:
    ...
    def test_header_values_match_expected(self, sample_token):
        ...
        assert headers["User-Agent"] == "Mozilla/5.0 (Linux; Android 16; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Mobile Safari/537.36 HuaWei-AnyOffice/1.0.0/cn.edu.fafu.iportal"
